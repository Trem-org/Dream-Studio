...
const GEMINI_MODELS: GeminiModelId[] = ["gemini-3.5-flash", "gemini-3.1-pro-preview", "gemini-3-flash-preview"];
const SERVER_GEMMA_MODEL: GeminiModelId = "gemini-3.5-flash";
